...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LocalTrajectoryBuilderOptions2D, in_location_inserter_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::InitDefaults();
  ...
  ::cartographer::mapping::scan_matching::proto::protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto::InitDefaults();
  ::cartographer::mapping::scan_matching::proto::protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2freal_5ftime_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto::InitDefaults();
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2fsubmaps_5foptions_5f2d_2eproto::InitDefaults();
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2fin_5flocation_5finserter_2eproto::InitDefaults();
  _LocalTrajectoryBuilderOptions2D_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LocalTrajectoryBuilderOptions2D_default_instance_);_LocalTrajectoryBuilderOptions2D_default_instance_._instance.get_mutable()->adaptive_voxel_filter_options_ = const_cast< ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions*>(
      ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions::internal_default_instance());
  _LocalTrajectoryBuilderOptions2D_default_instance_._instance.get_mutable()->loop_closure_adaptive_voxel_filter_options_ = const_cast< ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions*>(
      ::cartographer::sensor::proto::AdaptiveVoxelFilterOptions::internal_default_instance());
  _LocalTrajectoryBuilderOptions2D_default_instance_._instance.get_mutable()->real_time_correlative_scan_matcher_options_ = const_cast< ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions*>(
      ::cartographer::mapping::scan_matching::proto::RealTimeCorrelativeScanMatcherOptions::internal_default_instance());
  _LocalTrajectoryBuilderOptions2D_default_instance_._instance.get_mutable()->ceres_scan_matcher_options_ = const_cast< ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions2D*>(
      ::cartographer::mapping::scan_matching::proto::CeresScanMatcherOptions2D::internal_default_instance());
  _LocalTrajectoryBuilderOptions2D_default_instance_._instance.get_mutable()->motion_filter_options_ = const_cast< ::cartographer::mapping::proto::MotionFilterOptions*>(
      ::cartographer::mapping::proto::MotionFilterOptions::internal_default_instance());
  _LocalTrajectoryBuilderOptions2D_default_instance_._instance.get_mutable()->in_location_inserter_ = const_cast< ::cartographer::mapping::proto::InLocationInserterOptions*>(
      ::cartographer::mapping::proto::InLocationInserterOptions::internal_default_instance());
  _LocalTrajectoryBuilderOptions2D_default_instance_._instance.get_mutable()->pose_extrapolator_options_ = const_cast< ::cartographer::mapping::proto::PoseExtrapolatorOptions*>(
      ::cartographer::mapping::proto::PoseExtrapolatorOptions::internal_default_instance());
  _LocalTrajectoryBuilderOptions2D_default_instance_._instance.get_mutable()->submaps_options_ = const_cast< ::cartographer::mapping::proto::SubmapsOptions2D*>(
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "ps_options_2d.proto\0325cartographer/mappin"
      "g/proto/in_location_inserter.proto\"\250\010\n\037L"
      "ocalTrajectoryBuilderOptions2D\022\021\n\tmin_ra"
      "nge\030\016 \001(\002\022\021\n\tmax_range\030\017 \001(\002\022\r\n\005min_z\030\001 "
      "\001(\002\022\r\n\005max_z\030\002 \001(\002\022\037\n\027missing_data_ray_l"
      "ength\030\020 \001(\002\022\"\n\032num_accumulated_range_dat"
      "a\030\023 \001(\005\022\031\n\021voxel_filter_size\030\003 \001(\002\022\\\n\035ad"
      "aptive_voxel_filter_options\030\006 \001(\01325.cart"
      "ographer.sensor.proto.AdaptiveVoxelFilte"
      "rOptions\022i\n*loop_closure_adaptive_voxel_"
      "filter_options\030\024 \001(\01325.cartographer.sens"
      "or.proto.AdaptiveVoxelFilterOptions\022,\n$u"
      "se_online_correlative_scan_matching\030\005 \001("
      "\010\022\203\001\n*real_time_correlative_scan_matcher"
      "_options\030\007 \001(\0132O.cartographer.mapping.sc"
      "an_matching.proto.RealTimeCorrelativeSca"
      "nMatcherOptions\022g\n\032ceres_scan_matcher_op"
      "tions\030\010 \001(\0132C.cartographer.mapping.scan_"
      "matching.proto.CeresScanMatcherOptions2D"
      "\022N\n\025motion_filter_options\030\r \001(\0132/.cartog"
      "rapher.mapping.proto.MotionFilterOptions"
      "\022S\n\024in_location_inserter\030\026 \001(\01325.cartogr"
      "apher.mapping.proto.InLocationInserterOp"
      "tions\022!\n\031imu_gravity_time_constant\030\021 \001(\001"
      "\022V\n\031pose_extrapolator_options\030\025 \001(\01323.ca"
      "rtographer.mapping.proto.PoseExtrapolato"
      "rOptions\022E\n\017submaps_options\030\013 \001(\0132,.cart"
      "ographer.mapping.proto.SubmapsOptions2D\022"
  ...
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2fpose_5fextrapolator_5foptions_2eproto::AddDescriptors();
  ...
  ::cartographer::mapping::scan_matching::proto::protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto::AddDescriptors();
  ::cartographer::mapping::scan_matching::proto::protobuf_cartographer_2fmapping_2fproto_2fscan_5fmatching_2freal_5ftime_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto::AddDescriptors();
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2fsubmaps_5foptions_5f2d_2eproto::AddDescriptors();
  ::cartographer::mapping::proto::protobuf_cartographer_2fmapping_2fproto_2fin_5flocation_5finserter_2eproto::AddDescriptors();
}
} // anonymous namespace
...
const int LocalTrajectoryBuilderOptions2D::kInLocationInserterFieldNumber;
...
LocalTrajectoryBuilderOptions2D::LocalTrajectoryBuilderOptions2D(const LocalTrajectoryBuilderOptions2D& from)
  ...
  if (from.has_in_location_inserter()) {
    in_location_inserter_ = new ::cartographer::mapping::proto::InLocationInserterOptions(*from.in_location_inserter_);
  } else {
    in_location_inserter_ = NULL;
  }
...
void LocalTrajectoryBuilderOptions2D::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete in_location_inserter_;
}
...
// @@protoc_insertion_point(message_clear_start:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D)
  ...
  pose_extrapolator_options_ = NULL;
  if (GetArenaNoVirtual() == NULL && in_location_inserter_ != NULL) {
    delete in_location_inserter_;
  }
  in_location_inserter_ = NULL;
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // .cartographer.mapping.proto.InLocationInserterOptions in_location_inserter = 22;
      case 22: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(178u /* 178 & 0xFF */)) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_in_location_inserter()));
        } else {
          goto handle_unusual;
        }
        break;
...
void LocalTrajectoryBuilderOptions2D::SerializeWithCachedSizes(
  ...
  // .cartographer.mapping.proto.InLocationInserterOptions in_location_inserter = 22;
  if (this->has_in_location_inserter()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      22, *this->in_location_inserter_, output);
  }
...
::google::protobuf::uint8* LocalTrajectoryBuilderOptions2D::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_in_location_inserter()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        22, *this->in_location_inserter_, deterministic, target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D)
  ...
  if (from.has_in_location_inserter()) {
    mutable_in_location_inserter()->::cartographer::mapping::proto::InLocationInserterOptions::MergeFrom(from.in_location_inserter());
  }
  if (from.min_z() != 0) {
...
void LocalTrajectoryBuilderOptions2D::InternalSwap(LocalTrajectoryBuilderOptions2D* other) {
  ...
  swap(in_location_inserter_, other->in_location_inserter_);
...
// .cartographer.mapping.proto.InLocationInserterOptions in_location_inserter = 22;
bool LocalTrajectoryBuilderOptions2D::has_in_location_inserter() const {
  return this != internal_default_instance() && in_location_inserter_ != NULL;
}
void LocalTrajectoryBuilderOptions2D::clear_in_location_inserter() {
  if (GetArenaNoVirtual() == NULL && in_location_inserter_ != NULL) delete in_location_inserter_;
  in_location_inserter_ = NULL;
}
const ::cartographer::mapping::proto::InLocationInserterOptions& LocalTrajectoryBuilderOptions2D::in_location_inserter() const {
  const ::cartographer::mapping::proto::InLocationInserterOptions* p = in_location_inserter_;
  // @@protoc_insertion_point(field_get:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.in_location_inserter)
  return p != NULL ? *p : *reinterpret_cast<const ::cartographer::mapping::proto::InLocationInserterOptions*>(
      &::cartographer::mapping::proto::_InLocationInserterOptions_default_instance_);
}
::cartographer::mapping::proto::InLocationInserterOptions* LocalTrajectoryBuilderOptions2D::mutable_in_location_inserter() {
  
  if (in_location_inserter_ == NULL) {
    in_location_inserter_ = new ::cartographer::mapping::proto::InLocationInserterOptions;
  }
  // @@protoc_insertion_point(field_mutable:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.in_location_inserter)
  return in_location_inserter_;
}
::cartographer::mapping::proto::InLocationInserterOptions* LocalTrajectoryBuilderOptions2D::release_in_location_inserter() {
  // @@protoc_insertion_point(field_release:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.in_location_inserter)
  
  ::cartographer::mapping::proto::InLocationInserterOptions* temp = in_location_inserter_;
  in_location_inserter_ = NULL;
  return temp;
}
void LocalTrajectoryBuilderOptions2D::set_allocated_in_location_inserter(::cartographer::mapping::proto::InLocationInserterOptions* in_location_inserter) {
  delete in_location_inserter_;
  in_location_inserter_ = in_location_inserter;
  if (in_location_inserter) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_set_allocated:cartographer.mapping.proto.LocalTrajectoryBuilderOptions2D.in_location_inserter)
}
...
const ::cartographer::mapping::proto::PoseExtrapolatorOptions& LocalTrajectoryBuilderOptions2D::pose_extrapolator_options() const {
...
::cartographer::mapping::proto::PoseExtrapolatorOptions* LocalTrajectoryBuilderOptions2D::mutable_pose_extrapolator_options() {
...
::cartographer::mapping::proto::PoseExtrapolatorOptions* LocalTrajectoryBuilderOptions2D::release_pose_extrapolator_options() {
...
void LocalTrajectoryBuilderOptions2D::set_allocated_pose_extrapolator_options(::cartographer::mapping::proto::PoseExtrapolatorOptions* pose_extrapolator_options) {
  delete pose_extrapolator_options_;
